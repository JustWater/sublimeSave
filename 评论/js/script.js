$(function(){
	...
	// 	// e.stopPropagation();
	// 	// console.log(2);
	// 	// $(".commentInput").removeClass('commentInputFocus');
	// 	// $(this).focus();
	// 	// $(this).addClass("commentInputFocus");
	// 	// if($(this).val()==""){
	// 	// 	$(this).attr("placeholder","")
	// 	// }
	// 	// // 文本输入框
	...
	// 	// })
	// })
	// $(".commentArea").on('click','.commentInput',function(e){
		// e.stopPropagation();
		// console.log(2);
		// $(".commentInput").removeClass('commentInputFocus');
		// $(this).focus();
	...
	$(document).on('click',".commentBtn",function(){
		...
		if(commentInput.val()!=""){
			...
			'<img src="'+userImg.attr("src")+'" class="userImg">'+
			'<div class="userMes">'+
			'<div class="userBlock">'+
			'<div class="userAbout">'+
...
function createReply(obj){
	...
	'<span class="replyContent"> '+textVal+'</span>'+
	'</div>'+
